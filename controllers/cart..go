...
import (
	...
	"github.com/kittichanr/golang-ecommerce/models"
...
func (app *Application) GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := UserCollection.FindOne(ctx, bson.D{primitive.E{Key: "_id", Value: user_id_hex}}).Decode(&filledcart)
		if err != nil {
			log.Println(err)
			c.IndentedJSON(500, "not found")
			return
		}
		filter_match := bson.D{{Key: "$match", Value: bson.D{primitive.E{Key: "_id", Value: user_id_hex}}}}
...
func (app *Application) BuyFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		database.BuyItemFromCart(ctx, app.prodCollection, app.userCollection, userQueryID)
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, err)
		}
